...
def search():
    ...
    def search_name():
        ...
        for each_cell in range(2, excel_activate.max_row + 1):
            if s_name == str(excel_activate['B'+str(each_cell)].value).lower:
    ...
    exit_btn = Button(Search,text='Exit',width=30,bg='gray',fg='white',font=('courier',23,'bold'),borderwidth=4, relief="groove",command=lambda:exit_function())
...
print_text = Text(frame2,width=35,height=28,font=('courier',20,'bold'),bg='dimgray',fg='white')
