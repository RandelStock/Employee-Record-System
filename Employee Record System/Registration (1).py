...
name_entry = Entry(root,width=24,font=("Times",30))
...
age_combo = ttk.Combobox(root, textvariable= age_var,value =age_list ,width=23,font=("Times",30))
...
sex_var = StringVar()
male_button = Radiobutton(root,text="MALE",value="Male Selected",variable=sex_var,font=("Times",12))
female_button = Radiobutton(root,text="FEMALE",value="Female Selected",variable=sex_var,font=("Times",12))
...
course_var = IntVar()
math = Checkbutton (root,text="Mathematics",variable=course_var,command=lambda:addtolist(course_var.get(),math),font=("Times",10))
course_var2 = IntVar()
physics = Checkbutton (root,text="Physics",variable=course_var2,command=lambda:addtolist(course_var2.get(),physics),font=("Times",10))
course_var3 = IntVar()
program = Checkbutton (root,text="Programming",variable=course_var3,command=lambda:addtolist(course_var3.get(),program),font=("Times",10))
...
department_combo = ttk.Combobox(root,textvariable=department_var,value=department_list,width=23,font=("Times",30))
...
year_combo = ttk.Combobox(root,textvariable=year_var,value=year_list,width=23,font=("Times",30))

year_label.grid(row=8,column=0,padx=7,pady=7)
year_combo.grid(row=8,column=1,padx=7,pady=7)

address_label = Label(root,text="Address :",width=15,height=2,padx=7,pady=7)
address_text = Text(root,width=77,height=2,padx=7,pady=7,font=("Times",10))

address_label.grid(row=9,column=0,padx=7,pady=7)
address_text.grid(row=9,column=1,padx=7,pady=7)

phone_label = Label(root,text="Phone :",width=15,height=2,padx=7,pady=7)
phone_text = Text(root,width=77,height=2,padx=7,pady=7,font=("Times",10))

phone_label.grid(row=10,column=0,padx=7,pady=7)
phone_text.grid(row=10,column=1,padx=7,pady=7)

description_label = Label(root,text="Description :",width=15,height=2,padx=7,pady=7)
description_text = Text(root,width=77,height=2,padx=7,pady=7,font=("Times",10))

description_label.grid(row=11,column=0,padx=7,pady=7)
description_text.grid(row=11,column=1,padx=7,pady=7)

register_button = Button(root,text="REGISTER",width=30,height=3,padx=7,pady=7,font=("Times"))
